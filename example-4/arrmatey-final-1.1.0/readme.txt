...
= 1.1.0 =
* More variety in text replacement
* Bugfix: Text replacement skips HTML tags and attributes with post contents
...
= 1.1.0 =
* This version fixes a bug that can cause invalid/broken HTML in post content.