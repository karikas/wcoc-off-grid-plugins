...
class ARRMatey {
	...
	public function __construct() {
		...
		// Plugin Updates Example 2: WP Plugin Update Server
		...
		// Enable updates talking to "server" WordPress installation
		// Note that there is a bug in Windows where paths with \ won't work
		// Quick fix is to replace \ with / in paths
		$dummy_plugin_updater = new WP_Plugin_Updater(
			'https://wcoctest.kinsta.com',
